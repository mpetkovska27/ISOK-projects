...
<?php if ($event): ?>
    <form action="../handlers/edit_handler.php" method="post">
        ...
        <select name="type" id="type">
            <option <?php echo htmlspecialchars($event['type']) === 'javen' ? 'selected' : ''; ?> value="javen">javen</option>
            <option <?php echo htmlspecialchars($event['type']) === 'privaten' ? 'selected' : ''; ?> value="privaten">privaten</option>        </select>
        <br/>
